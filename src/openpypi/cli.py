...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="OpenPypi - Complete Python Project Generator", prog="openpypi"
    )
    ...
    generate_parser.add_argument("--author", default="Developer", help="Author name")
    generate_parser.add_argument("--email", default="developer@example.com", help="Author email")
    ...
    generate_parser.add_argument(
        "--no-fastapi", action="store_true", help="Disable FastAPI integration"
    )
    generate_parser.add_argument(
        "--no-openai", action="store_true", help="Disable OpenAI integration"
    )
    generate_parser.add_argument("--no-docker", action="store_true", help="Disable Docker support")
    generate_parser.add_argument("--no-tests", action="store_true", help="Disable test generation")
    generate_parser.add_argument("--no-git", action="store_true", help="Skip git initialization")
    generate_parser.add_argument(
        "--test-framework",
